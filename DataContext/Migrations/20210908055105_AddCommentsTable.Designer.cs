...
namespace DataContext.Migrations
{
    ...
    [Migration("20210908055105_AddCommentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.Factor.RequestForCheckout", b =>
                {
                    b.Property<int>("RequestForCheckoutID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("RequestForCheckoutStatusID")
                        .HasColumnType("int");

                    b.HasKey("RequestForCheckoutID");

                    b.HasIndex("EmployeeID");

                    b.HasIndex("RequestForCheckoutStatusID");

                    b.ToTable("RequestForCheckout");
                });

            modelBuilder.Entity("Models.Entities.Factor.RequestForCheckoutStatus", b =>
                {
                    b.Property<int>("RequestForCheckoutStatusID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RequestForCheckoutStatusID");

                    b.ToTable("RequestForCheckoutStatus");
                });

            modelBuilder.Entity("Models.Entities.Score.Scores", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.User.Comment", b =>
                {
            ...
            modelBuilder.Entity("Models.Entities.Works.Tariff", b =>
                {
                    b.Property<int>("TariffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("TariffPercent")
                        .HasColumnType("int");

                    b.Property<string>("TariffTitle")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Models.Entities.Factor.InvoicingDetail", b =>
                {
                    ...
                    b.HasOne("Models.Entities.Works.Tariff", "Tariff")
                        .WithMany("invoicingDetails")
            ...
            modelBuilder.Entity("Models.Entities.Factor.RequestForCheckout", b =>
                {
                    b.HasOne("Models.Entities.User.User", "User")
                        .WithMany("RequestForCheckouts")
                        .HasForeignKey("EmployeeID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Models.Entities.Factor.RequestForCheckoutStatus", "RequestForCheckoutStatus")
                        .WithMany("RequestForCheckouts")
                        .HasForeignKey("RequestForCheckoutStatusID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("RequestForCheckoutStatus");
            ...
            modelBuilder.Entity("Models.Entities.Factor.RequestForCheckoutStatus", b =>
                {
                    b.Navigation("RequestForCheckouts");
                });
            ...
            modelBuilder.Entity("Models.Entities.User.User", b =>
                {
                    ...
                    b.Navigation("ScoresEmployee");

                    b.Navigation("ScoresUser");
